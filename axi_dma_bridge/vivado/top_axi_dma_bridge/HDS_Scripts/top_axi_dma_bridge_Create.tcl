...
set xilinxProject "./top_axi_dma_bridge.xpr"
set library axi_dma_bridge
set unit top_axi_dma_bridge
set view struct
set removeIP 0
set removeHDL 0
set forceRecreate 0
...
puts "   ./HDS_Scripts/top_axi_dma_bridge_fileList.tcl"
set hdlFileList ./HDS_Scripts/top_axi_dma_bridge_fileList.tcl
         ...
         if {$cuCopyIP} {
            if {[lsearch -regexp [array names cores] ",ipDir"] < 0 || [lsearch -regexp [array names cores] ",ipName"] < 0 || [lsearch -regexp [array names cores] ",fileList"] < 0 || [lsearch -regexp [array names cores] ",IP"] < 0} {
               ...
               if {[string length $ipDestDir]} {
                  ...
                  if {[regexp {\.(xco|xci)$} [file extension $path]]} {
