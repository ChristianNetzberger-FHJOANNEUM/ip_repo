...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_USE_TARGET_ADDR_FIFO"
...
proc update_PARAM_VALUE.C_USE_TARGET_ADDR_FIFO { PARAM_VALUE.C_USE_TARGET_ADDR_FIFO } {
	# Procedure called to update C_USE_TARGET_ADDR_FIFO when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_USE_TARGET_ADDR_FIFO { PARAM_VALUE.C_USE_TARGET_ADDR_FIFO } {
	# Procedure called to validate C_USE_TARGET_ADDR_FIFO
	return true
}
...
proc update_MODELPARAM_VALUE.C_USE_TARGET_ADDR_FIFO { MODELPARAM_VALUE.C_USE_TARGET_ADDR_FIFO PARAM_VALUE.C_USE_TARGET_ADDR_FIFO } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_USE_TARGET_ADDR_FIFO}] ${MODELPARAM_VALUE.C_USE_TARGET_ADDR_FIFO}
}
